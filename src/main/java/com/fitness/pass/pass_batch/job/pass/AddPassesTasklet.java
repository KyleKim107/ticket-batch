...
import com.fitness.pass.pass_batch.repository.pass.*;
import com.fitness.pass.pass_batch.repository.user.UserGroupMappingEntity;
import com.fitness.pass.pass_batch.repository.user.UserGroupMappingRepository;
...
public class AddPassesTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        log.info("startedAt - " + startedAt.toString());
        // 시작일자 보다 늦게 생성된 bulkpass들을 생성해 둔다.
        ...
        log.info("bulkPassEntities - " + bulkPassEntities.size());
