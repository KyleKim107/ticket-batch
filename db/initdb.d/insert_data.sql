...
(DATE_SUB(NOW(), INTERVAL 1 DAY), 210, 180, 0),
(DATE_SUB(NOW(), INTERVAL 2 DAY), 210, 180, 30),
(DATE_SUB(NOW(), INTERVAL 3 DAY), 220, 170, 50),
(DATE_SUB(NOW(), INTERVAL 4 DAY), 230, 160, 70),
(DATE_SUB(NOW(), INTERVAL 5 DAY), 240, 150, 90),
(DATE_SUB(NOW(), INTERVAL 6 DAY), 250, 140, 110),
(DATE_SUB(NOW(), INTERVAL 7 DAY), 260, 130, 130),
(DATE_SUB(NOW(), INTERVAL 8 DAY), 270, 120, 150),
(DATE_SUB(NOW(), INTERVAL 9 DAY), 280, 110, 170),
(DATE_SUB(NOW(), INTERVAL 10 DAY), 290, 100, 190);
